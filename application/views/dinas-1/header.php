                ...
                <div class="header-column">
                    <div style="text-align: center;"> 
						<?php 
							...
							echo "<img style='width:150px;' src='".base_url()."asset/logo/$row[gambar]'/>";
							}
							?>
						<h4><b><span style=" color: #fff;">PORTAL WEBSITE</span></b></h4>
						<h4><b><span style=" color: #fff;">PEMERINTAH KOTA SURAKARTA</span></b></h4>
                    </div>
                </div>
